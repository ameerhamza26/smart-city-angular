  ...
  public searchElementRef: ElementRef;
    ...
    ngOnInit() {
        ...
        this.userService.getPostTypes().subscribe((postType)=> {
            console.log((postType as any).data)
  ...
  private setCurrentLocation() {
    ...
    submitForm() {
      this.displayProgressSpinner = true;
        ...
        console.log("email", this.postForm.get('email').value)
        var brand = {
        ...
        formData.append('logo', this.imagePathOne);

        console.log(formData)
        this.userService.createBrand(formData).subscribe((res)=> {
