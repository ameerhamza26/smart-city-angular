...
@Component({
  selector: 'app-progress-spinner-two',
  templateUrl: './progress-spinner-two.component.html',
  styleUrls: ['./progress-spinner-two.component.css']
})
export class ProgressSpinnerTwoComponent {
